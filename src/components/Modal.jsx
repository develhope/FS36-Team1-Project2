        ...
        <form id={style["form-cuore"]}>
          <div id={style["form-container"]}>
            <div id={style["accedi-container"]}>
              ...
              <h4 id={style["h4-accedi"]}>Accedi o registrati</h4>
            </div>
            <hr id={style["hr"]} />
            <div id={style["numero-container"]}>
              <h3 id={style["h3-benvenuto"]}>
                Ti diamo il benvenuto su Airbnb
              </h3>
              <div id={style["select"]}>
                <small id={style["testo-paese"]}>Paese o area geografica</small>
                <select id={style["select-prefissi"]} defaultValue="39">
              ...
              <input
                id={style["input-numero"]}
                type="number"
                placeholder="Numero di telefono"
              />
              <p id={style["testo"]}>
                <small>
                  Ti chiameremo o ti invieremo un messaggio per confermare il
                  tuo numero. Sono previsti costi standard per messaggi e
                  traffico dati.{" "}
                  <a href="" id={style["link-privacy"]}>
                    Informativa sulla Privacy
                  </a>
                </small>
              </p>
              <button id={style["btn-continua-main"]}>Continua</button>
            </div>
            <div id={style["container-hr"]}>
              <hr id={style["hr-continua"]} />
              <p id={style["o"]}>o</p>
              <hr id={style["hr-continua"]} />
            </div>
            <div id={style["continua-container"]}>
              <button>
                <div id={style["btn-continua"]}>
                  <div id={style["svg-google"]}>
                    <img
                      src="https://www.svgrepo.com/show/475656/google-color.svg"
                      alt=""
                    />
                  </div>
                  <div id={style["google"]}>Continua con Google</div>
                </div>
              </button>
              <button>
                <div id={style["btn-continua"]}>
                  ...
                  <div id={style["apple"]}>Continua con Apple</div>
                </div>
              </button>
              <button>
                <div id={style["btn-continua"]}>
                  <div id={style["svg-email"]}>
                    <img
                      src="https://www.svgrepo.com/show/383305/email-envelope-letter-mail-message.svg"
                      alt=""
                    />
                  </div>
                  <div id={style["email"]}>Continua con un indirizzo email</div>
                </div>
              </button>
              <button>
                <div id={style["btn-continua"]}>
                  ...
                  <div id={style["facebook"]}>Continua con Facebook</div>
                </div>
              </button>
            </div>
          </div>
